...
class Ui_Imageur3D(object):
    def setupUi(self, Imageur3D):
        ...
        self.radioButton.setGeometry(QRect(690, 140, 82, 17))
        self.textEdit = QTextEdit(self.centralwidget)
        self.textEdit.setObjectName(u"textEdit")
        self.textEdit.setGeometry(QRect(513, 220, 271, 151))
    ...
    def retranslateUi(self, Imageur3D):
        ...
        self.radioButton.setText(QCoreApplication.translate("Imageur3D", u"RadioButton", None))
    # retranslateUi
